  ...
  return (
    <MantineProvider>
      <div className="p-1 h-screen bg-main-color max-w-full container mx-auto flex flex-col justify-between items-center space-x-0">
        ...
        <div className="flex flex-col space-x-6 max-w-full max-h-full">
        ...
        <div className="flex flex-row space-x-8">
          <Button className="bg-gradient-to-br from-b-gradient-from to-b-gradient-to opacity-45 text-white w-56 p-2 rounded-lg">
            Validate
          </Button>
          <Button className="bg-gradient-to-br from-b-gradient-from to-b-gradient-to opacity-45 text-white w-56 p-2 rounded-lg">
            Clean
